<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
										...
										<p class="pb-20 text-white">Vaibhav Real Estate helps you discover verified homes across India with clear pricing, trusted agents and a simple online booking experience.</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>India</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i><a class="text-white" href="tel:+917080703516">+91 7080703516</a></li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i><a class="text-white" href="mailto:vaibhavdvivedi6000@gmail.com">vaibhavdvivedi6000@gmail.com</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Vaibhav Real Estate</span> </div>
                    <div class="col-sm-6">
