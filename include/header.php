                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="tel:+917080703516"><i class="fas fa-phone-alt text-success mr-1"></i>+91 7080703516</a></li>
                                <li><a href="mailto:vaibhavdvivedi6000@gmail.com"><i class="fas fa-envelope text-success mr-1"></i>vaibhavdvivedi6000@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
										...
										<li class="nav-item dropdown">
											...
											<li class="nav-item"> <a class="nav-link" href="mybookings.php">My Orders</a> </li>
									...
									<a class="btn btn-success nav-cta d-none d-xl-block" href="submitproperty.php"><i class="fas fa-plus-circle mr-1"></i> List Property</a> 
                                </div>
                            </nav>
                        </div>
                    </div>
