                ...
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="text-success text-left h5 my-2 text-md-right">&#8377;<?php echo number_format($row['13']);?></div>
                                <div class="text-left text-md-right">Price</div>
                            </div>

                            <div class="bg-light border rounded p-4 mt-4">
                                <h5 class="text-secondary mb-2">Book this property</h5>
                                <p class="mb-3">Reserve it with a <strong><?php echo BOOKING_PERCENTAGE; ?>% booking amount (maximum &#8377;<?php echo number_format(BOOKING_MAX_AMOUNT); ?>)</strong>. The remaining amount is payable as agreed with the seller.</p>
                                <?php if($row['24'] === 'booked') { ?>
                                    <span class="btn btn-secondary disabled">Already Booked</span>
                                <?php } elseif(isset($_SESSION['uid'])) { ?>
                                    <a class="btn btn-success" href="booking.php?pid=<?php echo (int)$row['0']; ?>">Book now — &#8377;<?php echo number_format(booking_amount($row['13'])); ?></a>
                                <?php } else { ?>
                                    <a class="btn btn-success" href="login.php?redirect=booking.php?pid=<?php echo (int)$row['0']; ?>">Login to book this property</a>
                                <?php } ?>
                            </div>
                        </div>
