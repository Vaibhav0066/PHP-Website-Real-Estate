    ...
    <div class="row"> 
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-10 col-xl-9">
                        <div class="text-white modern-hero-content">
                            <span class="hero-kicker"><i class="fas fa-shield-alt"></i> Trusted property discovery in India</span>
                            <h1 class="mb-3">Find a place you'll<br><span>love to call home.</span></h1>
                            <p class="hero-subtitle">Explore verified homes, compare prices and reserve your next property online.</p>
                            <div class="hero-stats">
                                <div><strong>6+</strong><span>Indian cities</span></div>
                                <div><strong>100%</strong><span>Online token flow</span></div>
                                <div><strong>24/7</strong><span>Property support</span></div>
                            </div>
                            <form method="post" action="propertygrid.php" class="hero-search-card">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group mb-0">
                                            <button type="submit" name="filter" class="btn btn-success w-100"><i class="fas fa-search mr-2"></i>Search</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                        <div class="section-intro text-center"><span>OUR SERVICES</span><h2 class="text-secondary mb-2">Everything you need to find home</h2><p>Simple, transparent and built for confident property decisions.</p></div></div>
                </div>
                <div class="text-box-one">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
							<div class="service-card p-4 text-center rounded mb-4 transation-3s"> 
								<i class="flaticon-rent text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary py-3 m-0"><a href="property.php">Buy with confidence</a></h5>
                                <p>Discover curated homes with clear pricing, photos and complete details.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
							<div class="service-card p-4 text-center rounded mb-4 transation-3s"> 
								<i class="flaticon-for-rent text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary py-3 m-0"><a href="property.php">Smart property search</a></h5>
                                <p>Filter by location, home type and listing status in just a few clicks.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
							<div class="service-card p-4 text-center rounded mb-4 transation-3s"> 
								<i class="flaticon-list text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary py-3 m-0"><a href="submitproperty.php">List your property</a></h5>
                                <p>Reach genuine buyers with a complete, beautiful property listing.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
							<div class="service-card p-4 text-center rounded mb-4 transation-3s"> 
								<i class="flaticon-diagram text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary py-3 m-0"><a href="mybookings.php">Secure online booking</a></h5>
                                <p>Reserve available properties online with a simple token payment.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-intro text-center"><span>LATEST LISTINGS</span><h2 class="text-secondary mb-2">Homes you'll want to see</h2><p>Fresh properties from India's most popular residential destinations.</p></div>
                    </div>
                    <!--- <div class="col-md-6">
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b>&#8377;<?php echo number_format($row['13']);?> </b><span class="text-white"><?php echo $row['12'];?> Sqft</span></div>
                                            </div>
