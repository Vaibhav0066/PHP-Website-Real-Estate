	...
	if(!empty($email) && !empty($pass))
	{
		...
		$row=mysqli_fetch_array($result);
		   if($row){
				...
				if (strpos($redirect, '://') !== false || strpos($redirect, '//') === 0) $redirect = 'index.php';
                	...
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<!-- Form -->
								<form method="post">
									<input type="hidden" name="redirect" value="<?php echo isset($_GET['redirect']) ? htmlspecialchars($_GET['redirect'], ENT_QUOTES, 'UTF-8') : 'index.php'; ?>">
